export function Footer() {
  return (
    <>
      <footer className="w-full py-section-gap px-margin-desktop flex flex-col md:flex-row justify-between items-start border-t border-white/5 bg-primary text-on-primary">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-16">
          <div className="space-y-4">
            <p className="font-label-bold text-label-bold uppercase tracking-widest">Navigation</p>
          ...
          <div className="space-y-4">
            <p className="font-label-bold text-label-bold uppercase tracking-widest">Support</p>
            <ul className="space-y-2">
          ...
          <div className="space-y-4 col-span-2 md:col-span-1">
            <p className="font-label-bold text-label-bold uppercase tracking-widest">Newsletter</p>
      ...
      <div className="bg-primary py-8 px-margin-desktop border-t border-white/5 text-center text-on-primary/30 text-[12px] font-label-bold">
